document.addEventListener("DOMContentLoaded", () => {
	...
	const articlePublisherInfo = document.querySelector(".card__publisher");
	...
	shareBtn.addEventListener("mouseenter", () => {
		...
		paragraph.classList.add("share-menu");
	...
	shareBtn.addEventListener("mouseleave", () => {
		...
		articlePublisherInfo.removeChild(articlePublisherInfo.querySelector(".share-menu"));
	});
